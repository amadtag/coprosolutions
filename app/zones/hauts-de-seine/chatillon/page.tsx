...
export const metadata: Metadata = {
  title:
    "Nettoyage de copropriété à Châtillon (92320) | CoproSolutions",
  description:
    "CoproSolutions assure le nettoyage et l'entretien de copropriétés à Châtillon : parties communes, halls, escaliers, poubelles, parkings et entretien d'immeubles.",
  alternates: {
...
export default function ChatillonPage() {
  return (
    <LocalCityPage
      ...
      description="CoproSolutions accompagne les syndics, conseils syndicaux et gestionnaires immobiliers pour le nettoyage et l'entretien des copropriétés à Châtillon."
      intro={
        <>
          <p>
          ...
          <p>
            ...
            communs des résidences à Châtillon.
          </p>
          ...
          <p>
            Pour les immeubles professionnels et entreprises situés à
            Châtillon, découvrez également notre service de{" "}
            <a
