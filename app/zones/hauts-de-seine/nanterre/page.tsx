...
export const metadata: Metadata = {
  title:
    "Nettoyage et entretien de copropriété à Nanterre | CoproSolutions",
  description:
    "CoproSolutions assure le nettoyage et l'entretien de copropriétés à Nanterre : parties communes, poubelles, vitres, interventions ponctuelles et remplacement de gardiens.",
  alternates: {
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        copropriétés à <strong>Nanterre (92000)</strong>.
      </p>
      ...
      <h2>Une solution adaptée aux copropriétés de Nanterre</h2>

      <p>
        L'entretien régulier d'une copropriété contribue au confort des
        résidents et à la bonne présentation de l'immeuble. CoproSolutions
        adapte ses prestations aux caractéristiques et aux besoins de chaque
        résidence.
      </p>
      ...
      <h2>Remplacement de gardien à Nanterre</h2>
      ...
      <h2>Intervention dans les Hauts-de-Seine</h2>

      <p>
        CoproSolutions intervient à Nanterre et dans plusieurs communes des
        Hauts-de-Seine pour accompagner les copropriétés, syndics et
        gestionnaires immobiliers.
      </p>

      <p>
        <a href="/zones/hauts-de-seine">
          Découvrir nos interventions dans les Hauts-de-Seine
        </a>
      </p>

      <h2>Demander un devis à Nanterre</h2>

      <p>
        Vous êtes syndic, gestionnaire immobilier ou membre d'un conseil
        syndical à Nanterre ? Contactez CoproSolutions pour nous présenter
        votre résidence et obtenir une proposition adaptée à vos besoins.
      </p>
