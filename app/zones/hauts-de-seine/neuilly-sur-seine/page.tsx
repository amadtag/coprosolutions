...
export const metadata: Metadata = {
  title:
    "Nettoyage et entretien de copropriété à Neuilly-sur-Seine | CoproSolutions",
  description:
    "CoproSolutions assure le nettoyage et l'entretien de copropriétés à Neuilly-sur-Seine : parties communes, poubelles, vitres, interventions ponctuelles et remplacement de gardiens.",
  alternates: {
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        copropriétés à <strong>Neuilly-sur-Seine (92200)</strong>.
      </p>
      ...
      <h2>Nos services à Neuilly-sur-Seine</h2>
      ...
      <h2>Une solution adaptée aux copropriétés de Neuilly-sur-Seine</h2>
      ...
      <h2>Remplacement de gardien à Neuilly-sur-Seine</h2>
      ...
      <p>
        CoproSolutions intervient à Neuilly-sur-Seine et dans plusieurs
        communes des Hauts-de-Seine pour accompagner les copropriétés,
        syndics et gestionnaires immobiliers.
      </p>
      ...
      <h2>Demander un devis à Neuilly-sur-Seine</h2>

      <p>
        Vous êtes syndic, gestionnaire immobilier ou membre d'un conseil
        syndical à Neuilly-sur-Seine ? Contactez CoproSolutions pour nous
        présenter votre résidence et obtenir une proposition adaptée à vos
        besoins.
      </p>
